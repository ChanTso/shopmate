...
SELECT product_id, COUNT(*) AS orders, SUM(quantity) AS units, SUM(total_price_minor) AS amount_minor FROM paid WHERE currency='CNY' AND succeeded_at >= '2026-08-28' AND succeeded_at < '2026-09-05' GROUP BY product_id ORDER BY product_id;
