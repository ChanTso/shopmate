...
SELECT order_id, quantity, total_price_minor, succeeded_at
FROM paid WHERE product_id = 'shopmate-fixture-coffee'
  AND succeeded_at >= '2026-08-22 10:17:00'
  AND succeeded_at < '2026-08-23 10:17:00'
ORDER BY succeeded_at, order_id;
