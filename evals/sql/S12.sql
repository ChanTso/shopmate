...
SELECT product_id,
       SUM(CASE WHEN succeeded_at < '2026-08-22' THEN quantity ELSE 0 END) AS b_units,
       SUM(CASE WHEN succeeded_at >= '2026-08-22' THEN quantity ELSE 0 END) AS a_units,
       SUM(CASE WHEN succeeded_at < '2026-08-22' THEN total_price_minor ELSE 0 END) AS b_amount_minor,
       SUM(CASE WHEN succeeded_at >= '2026-08-22' THEN total_price_minor ELSE 0 END) AS a_amount_minor
