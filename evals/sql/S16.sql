...
SELECT COUNT(*) AS orders, SUM(quantity) AS units, SUM(total_price_minor) AS amount_minor
FROM paid WHERE product_id = 'shopmate-fixture-tea'
  AND succeeded_at >= '2026-08-08' AND succeeded_at < '2026-08-22';
