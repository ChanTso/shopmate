...
import type { ComparisonPayload } from "@/lib/buyer-types";
...
export default function ComparisonGrid({
  ...
  const currencies = new Set(entries.map(entry => entry.product.currency));
  const currency = currencies.size === 1 ? entries[0]?.product.currency : undefined;
